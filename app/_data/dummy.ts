...
export const DUMMY_PROJECTS: ProjectCreate[] = [
  {
    ...
    questions: [
      ...
      { question: '협업 경험에 대해 구체적으로 작성해주세요.', max_length: 800 },
    ],
  },
  {
    company: '카카오',
    ...
    questions: [
      { question: '가장 어려웠던 기술적 문제와 해결 과정을 설명해주세요.', max_length: 1200 },
    ],
  },
  {
    company: '삼성전자',
    ...
    questions: [
      { question: '본인의 성장 과정과 가치관을 설명해주세요.', max_length: 1500 },
      { question: '팀워크를 발휘한 경험을 구체적으로 작성해주세요.', max_length: 1000 },
    ],
  },
  {
    company: '토스',
    ...
    questions: [
      { question: '가장 몰입했던 프로젝트 경험을 설명해주세요.', max_length: 1000 },
    ],
  },
  {
    company: '라인',
    ...
    questions: [
      { question: '데이터를 활용하여 문제를 해결한 경험을 작성해주세요.', max_length: 1200 },
      { question: '기술적으로 도전했던 경험을 설명해주세요.', max_length: 1000 },
    ],
  },
];
...
export const DUMMY_EXPERIENCES: ExperienceCreate[] = [
  ...
  },
  {
    ...
    action: '원인을 분석하여 PR을 작성하고, 메인테이너와 코드 리뷰를 진행했습니다.',
  ...
  },
  {
    ...
    action: '독거노인 안부 확인 서비스를 기획하고, React Native로 MVP를 개발했습니다.',
    result: '참가팀 50개 중 1위를 차지하고, 지자체 시범 사업으로 선정되었습니다.',
  ...
  },
  {
    ...
    result: '주간 리포트 작성 시간을 30분으로 단축하고, 데이터 정확도를 향상시켰습니다.',
    category: EXPERIENCE_CATEGORY.LOGICAL_ANALYSIS,
  },
];
