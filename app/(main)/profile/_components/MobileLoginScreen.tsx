      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-10 w-full">
        ...
        <div className="flex w-full flex-col gap-3">
          ...
          <button
            type="button"
            disabled
            className="flex h-14 w-full items-center justify-center gap-3 rounded-3.5 border border-gray-70 bg-white text-body-5-2 text-gray-400 shadow-chat opacity-40"
          >
