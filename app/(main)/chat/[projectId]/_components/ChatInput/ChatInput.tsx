...
function SendIcon({ active }: { active: boolean }) {
  return (
    <svg width="19" height="19" viewBox="0 0 19.3037 19.3026" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function ChatInput({
  ...
  useEffect(() => {
    const wasGenerating = prevStatusRef.current === 'submitted' || prevStatusRef.current === 'streaming';
