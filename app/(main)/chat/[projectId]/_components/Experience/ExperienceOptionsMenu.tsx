    ...
    <DropdownMenu>
      ...
      >
        ...
        >
          ...
          <span className="text-body-5-3 text-gray-500">전체보기</span>
        </DropdownMenuItem>
        <DropdownMenuItem
          onClick={(e) => {
            e.stopPropagation();
        ...
        >
          ...
          <span className="text-body-5-3 text-gray-500">수정하기</span>
        </DropdownMenuItem>
        <DropdownMenuItem
          onClick={(e) => {
            e.stopPropagation();
        ...
        >
          ...
          <span className="text-body-5-3 text-gray-500">삭제하기</span>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
