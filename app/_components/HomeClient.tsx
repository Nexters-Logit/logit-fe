...
export function HomeClient({ projectListSlot }: HomeClientProps) {
  ...
  return (
    <main className="w-full mx-auto flex-1 overflow-y-auto scrollbar-hide outline-none">
      <HomeBanner />
      <div className="w-full max-w-368 mx-auto px-4 sm:px-6 lg:px-10 pt-20.75 sm:pt-23.5 lg:pt-31.25 pb-16 sm:pb-20 lg:pb-25">
        ...
        <section className="mb-10 sm:mb-14 lg:mb-21.25">
          ...
          <Carousel
            ...
            className="mt-3 sm:mt-5 lg:w-403 lg:-ml-17.5"
          >
